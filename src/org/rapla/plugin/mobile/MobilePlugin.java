...
public class MobilePlugin  implements PluginDescriptor
{
    ...
    public void provideServices(Container container, Configuration config) throws RaplaContextException {
    	...
    	container.addContainerProvidedComponent(RaplaExtensionPoints.PLUGIN_OPTION_PANEL_EXTENSION, MobilePluginOption.class);
        ...
        if (env.getStartupMode() == StartupEnvironment.SERVLET) {
	        ...
	        serviceContainer.addWebpage( "mobile",MobileCalendarPageGenerator.class);
