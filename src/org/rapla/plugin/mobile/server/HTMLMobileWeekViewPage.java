...
public class HTMLMobileWeekViewPage extends AbstractHTMLCalendarPage
{
    ...
    public String generateHTMLHead()
    {
		...
		htmlOut += "<script type=\"text/javascript\" src=\"mobileview/js/jquery.min.js\"></script>\n";
		
		// this file have to be loaded before jQuery mobile
		htmlOut += "<script type=\"text/javascript\" src=\"mobileview/js/jquery.mobile.pref.js\"></script>\n"; 
		
		htmlOut += "<script type=\"text/javascript\" src=\"mobileview/js/jquery.easing.js\"></script>\n";
		htmlOut += "<script type=\"text/javascript\" src=\"mobileview/js/jquery.mobile.js\"></script>\n";
		htmlOut += "<script type=\"text/javascript\" src=\"mobileview/js/jquery.mobile.scrollview.js\"></script>\n";
		htmlOut += "<script type=\"text/javascript\" src=\"mobileview/js/jquery.mobile.datebox.min.js\"></script>\n";
		htmlOut += "<script type=\"text/javascript\" src=\"mobileview/js/script.js\"></script>\n";

		// include css files
		htmlOut += "<link rel=\"stylesheet\" href=\"mobileview/js/jquery.mobile.css\" media=\"screen\" type=\"text/css\" />\n";
		htmlOut += "<link rel=\"stylesheet\" href=\"mobileview/css/mobile.css\" media=\"screen\" type=\"text/css\" />\n";
